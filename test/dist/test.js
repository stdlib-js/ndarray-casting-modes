...
tape( 'the function returns a list of ndarray casting modes', function test( t ) {
	var expected;
	var actual;
...
tape( 'attached to the main function is an `enum` method to return an object mapping casting modes to integer values for C inter-operation', function test( t ) {
	var obj;
	var o;
	var i;
	...
	// List of casting modes which should be supported...
	o = [
		'none',
		'equiv',
		'safe',
